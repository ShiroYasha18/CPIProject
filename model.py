...
# Load the dataset
spotify_df = pd.read_csv('/Users/ayrafraihan/PycharmProjects/CPIProject/data_moods.csv')  # Assuming the dataset is loaded locally
...
features_temp = ['danceability', 'energy', 'key', 'loudness', 'speechiness', 'acousticness', 'instrumentalness', 'liveness', 'valence', 'tempo']
